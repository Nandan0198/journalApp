...
If you want, I can also make a top 1% GitHub README (with badges + screenshots + live demo + recruiter appeal) 🔥

kindly keep it clean and good so that i can copy for copy and paste

Got it, Nandan — I see the issue 👍 (extra text + messy formatting).
Here is a clean, professional, perfectly formatted README — just copy paste this directly into GitHub:
